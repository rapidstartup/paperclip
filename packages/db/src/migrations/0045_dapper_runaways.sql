...
ALTER TABLE "companies" ADD COLUMN "github_token" text;--> statement-breakpoint
...
CREATE INDEX "vibedash_project_links_pm_agent_idx" ON "vibedash_project_links" USING btree ("pm_agent_id");--> statement-breakpoint
