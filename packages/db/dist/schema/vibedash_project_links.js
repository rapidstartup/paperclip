...
export const vibedashProjectLinks = pgTable("vibedash_project_links", {
    ...
    vibedashProjectIdUniqueIdx: uniqueIndex("vibedash_project_links_vibedash_project_id_idx").on(table.vibedashProjectId),
    companyUniqueIdx: uniqueIndex("vibedash_project_links_company_id_idx").on(table.companyId),
    companyStatusIdx: index("vibedash_project_links_company_status_idx").on(table.companyId, table.bootstrapStatus),
...
//# sourceMappingURL=vibedash_project_links.js.map