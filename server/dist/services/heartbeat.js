...
import { resolveDefaultAgentWorkspaceDir, resolveDefaultProjectWorkspaceFallbackDir, } from "../home-paths.js";
...
export function resolveRuntimeSessionParamsForWorkspace(input) {
    ...
    const previousIsProjectFallback = fallbackProjectCwd !== null && path.resolve(previousCwd) === path.resolve(fallbackProjectCwd);
    ...
    async function resolveWorkspaceForRun(agent, context, previousSessionParams, opts) {
        ...
        if (projectWorkspaceRows.length > 0) {
            ...
            if (missingProjectCwds.length > 0) {
                ...
                warnings.push(hasRepoWorkspace
