...
async function lookupInviteResolutionHostname(hostname) {
    let timeout = null;
    try {
...
async function resolveInviteResolutionTarget(url) {
...
async function probeInviteResolutionTarget(target, timeoutMs) {
