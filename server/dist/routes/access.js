...
function resolveSkillRoots() {
    ...
    const candidates = [
        path.resolve(moduleDir, "../../skills"), // published: dist/routes/ -> <pkg>/skills/
        path.resolve(process.cwd(), "skills"), // cwd (e.g. monorepo root)
        path.resolve(moduleDir, "../../../skills") // dev: src/routes/ -> repo root/skills/
    ];
    const seen = new Set();
    const roots = [];
