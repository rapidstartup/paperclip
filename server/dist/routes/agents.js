...
import { agentService, agentInstructionsService, accessService, approvalService, companySkillService, budgetService, heartbeatService, ISSUE_LIST_DEFAULT_LIMIT, issueApprovalService, issueService, logActivity, secretService, syncInstructionsBundleConfigFromFilePath, workspaceOperationService, } from "../services/index.js";
...
export function agentRoutes(db) {
    ...
    async function assertCanTestAdapterEnvironment(req, companyId) {
        assertCompanyAccess(req, companyId);
        if (req.actor.type === "board") {
            return null;
        }
    ...
    router.get("/heartbeat-runs/:runId", async (req, res) => {
        ...
        res.json(redactCurrentUserValue({ ...run, retryExhaustedReason }, await getCurrentUserRedactionOptions()));
    });
